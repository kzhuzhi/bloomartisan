        ...
        return (
            <div id="about" className="text-center">
                <div className="container">
                    ...
                    <p>We are a cosy and homely cafe in Singapore committed to offering affordable, handcrafted gelato, bakes and beverages that can be enjoyed by people from all walks of life. 
