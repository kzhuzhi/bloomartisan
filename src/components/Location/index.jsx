          ...
          <div id="row">
            <div className="col-md-6">
              <div className="col-md-10 col-md-offset-1">
                ...
                <br></br>
                <h5>order online</h5>
                <p><a href="https://bit.ly/bloom-grabfood" target="_blank" rel="noopener noreferrer">GrabFood</a></p>
                <p><a href="https://bloomartisan.oddle.me/en_SG" target="_blank" rel="noopener noreferrer">Oddle (islandwide delivery)</a></p>
              </div>
            </div>
            <div className="col-md-6">
